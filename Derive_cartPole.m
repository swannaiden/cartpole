...
%%%% Generate a matlab function for the Jacobian
dyn2 = [dx, dq, dyn(1), dyn(2)];
A = jacobian(dyn2, [x q dx dq]);
B = jacobian(dyn2, u);
% Create cartPoleJacobian.m
% 
% matlabFunction(A, B,'File','cartPoleJacobian',...
%     'Vars',{transpose([q x dq dx]),u,transpose([m1 m2 g l])})

% above matlab function is wrong for some reason
% [0,       0, 1, 0]
% [0,       0, 0, 1]
% [0, 981/100, 0, 0]
% [0,  981/50, 0, 0]
